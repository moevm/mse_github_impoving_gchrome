...
if(label[0] !== undefined) {
    let partUrl = window.location.pathname.split("/");
    let path = `https://api.github.com/repos/${partUrl[1]}/${partUrl[2]}/commits`;
    let usersCommits = [];
    ...
    xhttp.onreadystatechange = function (data) {
        if(this.readyState == 4 && this.status == 200) {
            ...
            for(let elem of usersCommits) {
                ...
                userRef.setAttribute('href', `/${partUrl[1]}/${partUrl[2]}/commits?author=${elem.name}`);
                ...
                commitRef.setAttribute('href', `/${partUrl[1]}/${partUrl[2]}/commit/${elem.sha}`);
                ...
                shaRef.setAttribute('href', `/${partUrl[1]}/${partUrl[2]}/commit/${elem.sha}`);
